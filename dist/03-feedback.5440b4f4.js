...
function onFormRedact() {
    if (localStorage.getItem(localStorageId)) parsedItems = JSON.parse(localStorage.getItem(localStorageId));
    else parsedItems = {
        email: "",
        message: ""
    };
    if (parsedItems.email !== undefined && parsedItems.email !== null) formInput.value = parsedItems.email;
    else formInput.value = "";
    if (parsedItems.message !== undefined && parsedItems.message !== null) formTextarea.value = parsedItems.message;
    else formTextarea.value = "";
}
